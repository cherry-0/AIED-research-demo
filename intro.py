...
st.write("2023 AIED 장기프로젝트 최종결과물 체험을 위한 페이지입니다. ")

st.write("연구 소개를 위한 게시글 링크는 https://aiednet.kr/sub_posting/posting_view.php?number=306&dp1=competition&cu_page=https://aiednet.kr/sub_competition/research.php 입니다.")
